...
{
    public partial class FirstMigrationWithSeeding : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ruben Fleischer", "Venom" },
                    { 2, "David Kerr", "Jhonny English" },
                    { 3, "Pierre Morel", "Peppermint" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "laci@gmail.com", "Laci", "06-70-707-0707" },
                    { 2, "peti@icloud.com", "Peti", "06-70- 606-0606" }
                });
